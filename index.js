...
function addGamesToPage(games) {
    ...
    for (let i = 0; i < games.length; i++) {
        ...
        <p>Pledged: USD $${games[i].pledged.toString()}</p>
        <p>Backers: ${games[i].backers.toString()}</p>
        `;
...
const message = `A total of $${totalRaised.toLocaleString()} has been 
    raised for ${GAMES_JSON.length} games. 
...
descriptionParagraph.textContent = message;
